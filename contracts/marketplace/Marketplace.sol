...
contract Marketplace is Ownable, Pausable, NativeMetaTransaction {
        ...
        onlyOwner
    {
        ...
        require(
            ...
            "Marketplace#setFeesCollectorCutPerMillion: TOTAL_FEES_MUST_BE_BETWEEN_0_AND_999999"
        );
        ...
        onlyOwner
    {
        ...
        require(
            feesCollectorCutPerMillion + royaltiesCutPerMillion < 1000000,
            "Marketplace#setRoyaltiesCutPerMillion: TOTAL_FEES_MUST_BE_BETWEEN_0_AND_999999"
        );
    ...
    function setFeesCollector(address _newFeesCollector) public onlyOwner {
        require(
            ...
            "Marketplace#setFeesCollector: INVALID_FEES_COLLECTOR"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "Marketplace#setRoyaltiesManager: INVALID_ROYALTIES_MANAGER"
        );
    ...
    function _createOrder(
        ...
        require(
            sender == assetOwner,
            "Marketplace#_createOrder: NOT_ASSET_OWNER"
        );
        require(
        ...
        require(
            ...
            "Marketplace#_createOrder: INVALID_EXPIRES_AT"
        );
        ...
        if (publicationFeeInWei > 0) {
            require(
                ...
                "Marketplace#_createOrder: TRANSFER_FAILED"
            );
        }
        ...
        returns (Order memory)
    {
        ...
        require(
            ...
            "Marketplace#_cancelOrder: UNAUTHORIZED_USER"
        );
    ...
    function _executeOrder(
        ...
        if (nftRegistry.supportsInterface(InterfaceId_ValidateFingerprint)) {
            require(
                ...
                "Marketplace#_executeOrder: INVALID_FINGERPRINT"
            );
        }
        Order memory order = orderByAssetId[nftAddress][assetId];
        ...
        require(
            ...
            "Marketplace#_executeOrder: INVALID_SELLER"
        );
        require(
            order.seller != sender,
            "Marketplace#_executeOrder: SENDER_IS_SELLER"
        );
        require(
            order.price == price,
            "Marketplace#_executeOrder: PRICE_MISMATCH"
        );
        require(
            block.timestamp < order.expiresAt,
            "Marketplace#_executeOrder: ORDER_EXPIRED"
        );
        require(
            order.seller == nftRegistry.ownerOf(assetId),
            "Marketplace#_executeOrder: SELLER_NOT_OWNER"
        );
            ...
            if (success) {
                ...
                if (royaltiesReceiver != address(0)) {
                    require(
                        ...
                        "Marketplace#_executeOrder: TRANSFER_FEES_TO_ROYALTIES_RECEIVER_FAILED"
                    );
                }
            }
        }
    ...
    function _requireERC721(address nftAddress) internal view {
        require(
            ...
            "Marketplace#_requireERC721: INVALID_NFT_ADDRESS"
        );
